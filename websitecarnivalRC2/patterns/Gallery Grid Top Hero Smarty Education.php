<?php
/**
 * Title: Gallery Grid Top Hero
 * Slug: gallery-grid-top-hero
 * Categories: Hero
...
<div class="wp-block-group alignfull is-style-no-block-gap"><!-- wp:cover {"url":"https://themes.websitecarnival.com/school/wp-content/uploads/sites/9/2022/04/young-students-classroom.jpg","id":893,"dimRatio":10,"overlayColor":"foreground","focalPoint":{"x":"0.52","y":"0.36"},"minHeight":532,"minHeightUnit":"px"} -->
<div class="wp-block-cover" style="min-height:532px"><span aria-hidden="true" class="has-foreground-background-color has-background-dim-10 wp-block-cover__gradient-background has-background-dim"></span><img class="wp-block-cover__image-background wp-image-893" alt="" src="https://themes.websitecarnival.com/school/wp-content/uploads/sites/9/2022/04/young-students-classroom.jpg" style="object-position:52% 36%" data-object-fit="cover" data-object-position="52% 36%"/><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"contentSize":"1100px"}} -->
...
<h2 class="has-text-align-center has-background-color has-text-color has-gilda-display-font-family" style="font-size:35px;margin-top:0px;margin-right:0px;margin-bottom:10px;margin-left:0px">Gallery Grid</h2>
<!-- /wp:heading -->
