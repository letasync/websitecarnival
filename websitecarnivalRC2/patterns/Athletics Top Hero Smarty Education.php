<?php
/**
 * Title: Athletics Top Hero
 * Slug: athletics-top-hero
 * Categories: Hero
...
<div class="wp-block-group alignfull is-style-no-block-gap"><!-- wp:cover {"url":"https://themes.websitecarnival.com/school/wp-content/uploads/sites/9/2022/04/front-view-basketball-player-holding-ball-with-copy-space.jpg","id":272,"dimRatio":0,"focalPoint":{"x":"0.44","y":"0.32"},"minHeight":532,"minHeightUnit":"px"} -->
<div class="wp-block-cover" style="min-height:532px"><span aria-hidden="true" class="has-background-dim-0 wp-block-cover__gradient-background has-background-dim"></span><img class="wp-block-cover__image-background wp-image-272" alt="" src="https://themes.websitecarnival.com/school/wp-content/uploads/sites/9/2022/04/front-view-basketball-player-holding-ball-with-copy-space.jpg" style="object-position:44% 32%" data-object-fit="cover" data-object-position="44% 32%"/><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"contentSize":"1100px"}} -->
...
<h2 class="has-text-align-center has-background-color has-text-color has-gilda-display-font-family" style="font-size:35px;margin-top:0px;margin-right:0px;margin-bottom:10px;margin-left:0px">Athletics</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"400","fontSize":"16px"},"spacing":{"margin":{"bottom":"25px","top":"0px","right":"0px","left":"0px"}}},"textColor":"background"} -->
