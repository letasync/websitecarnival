<?php
/**
 * Title: Admissions Top Hero
 * Slug: admissions-top-hero
 * Categories: Hero
...
<div class="wp-block-group alignfull is-style-no-block-gap"><!-- wp:cover {"url":"https://themes.websitecarnival.com/school/wp-content/uploads/sites/9/2022/04/seattle-washington-usa-april-3-2021-university-campus-building-washington-university.jpg","id":317,"dimRatio":0,"overlayColor":"foreground","focalPoint":{"x":"0.44","y":"0.32"},"minHeight":532,"minHeightUnit":"px","isDark":false} -->
<div class="wp-block-cover is-light" style="min-height:532px"><span aria-hidden="true" class="has-foreground-background-color has-background-dim-0 wp-block-cover__gradient-background has-background-dim"></span><img class="wp-block-cover__image-background wp-image-317" alt="" src="https://themes.websitecarnival.com/school/wp-content/uploads/sites/9/2022/04/seattle-washington-usa-april-3-2021-university-campus-building-washington-university.jpg" style="object-position:44% 32%" data-object-fit="cover" data-object-position="44% 32%"/><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"contentSize":"1100px"}} -->
...
<h2 class="has-text-align-center has-background-color has-text-color has-gilda-display-font-family" style="font-size:35px;margin-top:0px;margin-right:0px;margin-bottom:10px;margin-left:0px">Admissions</h2>
<!-- /wp:heading -->
