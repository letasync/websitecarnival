<?php
/**
 * Title: Alumni Top Hero
 * Slug: alumni-top-hero
 * Categories: Hero
...
<div class="wp-block-group alignfull is-style-no-block-gap"><!-- wp:cover {"url":"https://themes.websitecarnival.com/school/wp-content/uploads/sites/9/2022/04/beautiful-student-girl-drinks-coffee-learning-home.jpg","id":313,"dimRatio":10,"overlayColor":"tertiary","focalPoint":{"x":"0.45","y":"0.20"},"minHeight":503,"minHeightUnit":"px","isDark":false} -->
<div class="wp-block-cover is-light" style="min-height:503px"><span aria-hidden="true" class="has-tertiary-background-color has-background-dim-10 wp-block-cover__gradient-background has-background-dim"></span><img class="wp-block-cover__image-background wp-image-313" alt="" src="https://themes.websitecarnival.com/school/wp-content/uploads/sites/9/2022/04/beautiful-student-girl-drinks-coffee-learning-home.jpg" style="object-position:45% 20%" data-object-fit="cover" data-object-position="45% 20%"/><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"contentSize":"1100px"}} -->
...
<h2 class="has-text-align-center has-background-color has-text-color has-gilda-display-font-family" style="font-size:35px;margin-top:0px;margin-right:0px;margin-bottom:10px;margin-left:0px">Alumni</h2>
<!-- /wp:heading -->
