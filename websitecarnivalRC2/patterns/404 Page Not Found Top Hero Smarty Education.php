<?php
/**
 * Title: 404 Page Not Found Top Hero
 * Slug: 404-page-not-found-top-hero
 * Categories: Hero
...
<div class="wp-block-group alignfull is-style-no-block-gap"><!-- wp:cover {"url":"https://themes.websitecarnival.com/school/wp-content/uploads/sites/9/2022/04/3d-render-404-error-page-found-design-pastel-color-background.jpg","id":555,"dimRatio":10,"overlayColor":"foreground","focalPoint":{"x":"0.45","y":"0.03"},"minHeight":532,"minHeightUnit":"px","isDark":false} -->
<div class="wp-block-cover is-light" style="min-height:532px"><span aria-hidden="true" class="has-foreground-background-color has-background-dim-10 wp-block-cover__gradient-background has-background-dim"></span><img class="wp-block-cover__image-background wp-image-555" alt="" src="https://themes.websitecarnival.com/school/wp-content/uploads/sites/9/2022/04/3d-render-404-error-page-found-design-pastel-color-background.jpg" style="object-position:45% 3%" data-object-fit="cover" data-object-position="45% 3%"/><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"contentSize":"1100px"}} -->
...
<div class="wp-block-columns are-vertically-aligned-center" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><!-- wp:column {"verticalAlignment":"center","width":"1000px","style":{"spacing":{"padding":{"top":"20px","right":"20px","bottom":"20px","left":"20px"},"margin":{"top":"10px"}},"color":{"background":"#011b3bba"},"border":{"radius":"10px","width":"0px","style":"none"}}} -->
<div class="wp-block-column is-vertically-aligned-center has-background" style="background-color:#011b3bba;border-radius:10px;border-style:none;border-width:0px;margin-top:10px;padding-top:20px;padding-right:20px;padding-bottom:20px;padding-left:20px;flex-basis:1000px"><!-- wp:heading {"textAlign":"center","style":{"typography":{"fontSize":"35px"},"spacing":{"margin":{"bottom":"10px","top":"0px","right":"0px","left":"0px"}}},"textColor":"background","fontFamily":"gilda-display"} -->
<h2 class="has-text-align-center has-background-color has-text-color has-gilda-display-font-family" style="font-size:35px;margin-top:0px;margin-right:0px;margin-bottom:10px;margin-left:0px">404 Page Not Found</h2>
<!-- /wp:heading -->
