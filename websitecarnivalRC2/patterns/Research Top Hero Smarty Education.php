<?php
/**
 * Title: Research Top Hero
 * Slug: research-top-hero
 * Categories: Hero
...
<div class="wp-block-group alignfull is-style-no-block-gap"><!-- wp:cover {"url":"https://themes.websitecarnival.com/school/wp-content/uploads/sites/9/2022/04/students-standing-with-open-books-looking-camera-2.jpg","id":443,"dimRatio":0,"focalPoint":{"x":"0.47","y":"0.00"},"minHeight":532,"minHeightUnit":"px","contentPosition":"center center","isDark":false} -->
<div class="wp-block-cover is-light" style="min-height:532px"><span aria-hidden="true" class="has-background-dim-0 wp-block-cover__gradient-background has-background-dim"></span><img class="wp-block-cover__image-background wp-image-443" alt="" src="https://themes.websitecarnival.com/school/wp-content/uploads/sites/9/2022/04/students-standing-with-open-books-looking-camera-2.jpg" style="object-position:47% 0%" data-object-fit="cover" data-object-position="47% 0%"/><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"contentSize":"1100px"}} -->
...
<h2 class="has-text-align-center has-background-color has-text-color has-gilda-display-font-family" style="font-size:35px;margin-top:0px;margin-right:0px;margin-bottom:10px;margin-left:0px">Research</h2>
<!-- /wp:heading -->
